        ...
        public NPE.Core.ITypedResponse<DTO.Library.APQP.APQP.KickOff> FindById(int id)
        {
            ...
            this.RunOnDB(context =>
            {
                ...
                else
                {
                    ...
                    if (string.IsNullOrEmpty(kickOff.DocuSignStatus) || kickOff.DocuSignStatus == DocuSignEnvelopeStatus.completed.ToString() || kickOff.DocuSignStatus == DocuSignEnvelopeStatus.declined.ToString() || kickOff.DocuSignStatus == DocuSignEnvelopeStatus.voided.ToString())
                 ...
                 else
                 {
                     ...
                     foreach (var apqpKickOffData in KickoffList)
                     {
                         ...
                         else
                         {
                             ...
                             if (string.IsNullOrEmpty(kickOff.DocuSignStatus) || kickOff.DocuSignStatus == DocuSignEnvelopeStatus.completed.ToString() || kickOff.DocuSignStatus == DocuSignEnvelopeStatus.voided.ToString() || kickOff.DocuSignStatus == DocuSignEnvelopeStatus.declined.ToString())
