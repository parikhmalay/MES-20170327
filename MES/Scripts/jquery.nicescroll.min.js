...
(function (e) {
    var x = !1,
        ...
        v = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || !1,
        w = window.cancelRequestAnimationFrame || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame ||
        window.msCancelRequestAnimationFrame || !1,
        y = window.MutationObserver || window.WebKitMutationObserver || !1,
        E = {
            zindex: "auto",
            cursoropacitymin: 0,
            cursoropacitymax: 1,
        ...
        L = function () {
            ...
            c.isie10 = c.isie && "performance" in
                window && 10 <= document.documentMode;
            ...
            c.hasmstouch = window.navigator.msPointerEnabled ||
                !1;
            ...
            c.prefixstyle = "";
            c.transitionend = !1;
            for (var h = "transition webkitTransition MozTransition OTransition OTransition msTransition KhtmlTransition".split(" "), m = " -webkit- -moz- -o- -o -ms- -khtml-".split(" "), b = "transitionend webkitTransitionEnd transitionend otransitionend oTransitionEnd msTransitionEnd KhtmlTransitionEnd".split(" "), l = 0; l < h.length; l++)
                if (h[l] in e.style) {
                    c.transitionstyle =
                        h[l];
                    c.prefixstyle = m[l];
            ...
            c.ischrome26 && (c.prefixstyle = m[1]);
            c.hastransition = c.transitionstyle;
            c.cursorgrabvalue = h;
            c.hasmousecapture = "setCapture" in e;
            c.hasMutationObserver = !1 !== y;
            return D = c
        },
        N = function (k, c) {
            function h() {
            ...
            function l(d, c, f) {
                c = d.css(c);
                d = parseFloat(c);
                return isNaN(d) ? (d = s[c] || 0, f = 3 == d ? f ? b.win.outerHeight() - b.win.innerHeight() : b.win.outerWidth() - b.win.innerWidth() : 1, b.isie8 && d && (d += 1), f ? d : 0) : d
            }
            ...
            function m(d, c, f) {
                var g = 0,
                    e = 0,
                    h = 1;
                "wheelDeltaY" in d ? (h = b.opt.mousescrollstep / 48, g = Math.floor(d.wheelDeltaX * h), e = Math.floor(d.wheelDeltaY * h), c && (0 == g && e) && (g = e, e = 0)) : (h = d.detail ?
                    -1 * d.detail : d.wheelDelta / 40) && (c ? g = Math.floor(h * b.opt.mousescrollstep) : e = Math.floor(h * b.opt.mousescrollstep));
                ...
                if (e) {
                    if (b.opt.nativeparentscrolling && f)
                        if (0 > e) {
            ...
            this.win = b.opt.win || (this.ispage ? e(window) :
                this.doc);
            ...
            this.page = this.view = this.onzoomout = this.onzoomin = this.onscrollcancel = this.onscrollend = this.onscrollstart = this.onclick = this.ongesturezoom = this.onkeypress = this.onmousewheel =
                this.onmousemove = this.onmouseup = this.onmousedown = !1;
            this.scroll = {
                x: 0,
                y: 0
            };
            ...
            this.observerremover = this.observer = this.scrollmom = this.scrollrunning = !1;
            do this.id = "ascrail" + J++; while (document.getElementById(this.id));
            ...
            if (this.ishwscroll) {
                ...
                this.getScrollTop = function (d) {
                    if (!d) {
                        if (d = t()) return 16 == d.length ? -d[13] : -d[5];
                ...
                this.getScrollLeft = function (d) {
                    if (!d) {
                        if (d = t()) return 16 == d.length ? -d[12] : -d[4];
                ...
                g.hastranslate3d && b.opt.enabletranslate3d ? (this.setScrollTop =
                    function (d, c) {
                        b.doc.translate.y = d;
                        ...
                        b.doc.translate.y = d;
                        b.doc.translate.ty = -1 * d + "px";
                        b.doc.css(g.trstyle, "translate(" +
                            b.doc.translate.tx + "," + b.doc.translate.ty + ")");
                        c || b.notifyScrollEvent(b.win[0])
                    }, this.setScrollLeft = function (d, c) {
                        b.doc.translate.x = d;
                        b.doc.translate.tx = -1 * d + "px";
            ...
            this.updateScrollBar = function (d) {
                if (b.ishwscroll) b.rail.css({
                    ...
                    b.win.outerWidth();
                    b.win.innerWidth();
                    var e = e + (b.rail.align ? b.win.outerWidth() - l(b.win, "border-right-width") - b.rail.width : l(b.win, "border-left-width")),
                        g = b.opt.railoffset;
                    g && (g.top && (f += g.top), b.rail.align && g.left && (e += g.left));
                    b.locked || b.rail.css({
                        top: f,
                        left: e,
                    ...
                    b.zoom && b.zoom.css({
                        top: f + 1,
                        left: 1 == b.rail.align ? e - 20 : e + b.rail.width + 4
                    });
                    b.railh && !b.locked && (f = c.top, e = c.left, d = b.railh.align ? f + l(b.win, "border-top-width", !0) + b.win.innerHeight() - b.railh.height : f + l(b.win, "border-top-width", !0), e += l(b.win, "border-left-width"), b.railh.css({
                        top: d,
                        left: e,
                        width: b.railh.width
                    }))
            ...
            this.doRailClick = function (d, c, f) {
                var e;
                !(b.rail.drag && 1 != b.rail.drag.pt) && (!b.locked && !b.rail.drag) && (b.cancelScroll(), b.cancelEvent(d), c ? (c = f ? b.doScrollLeft :
                    b.doScrollTop, e = f ? (d.pageX - b.railh.offset().left - b.cursorwidth / 2) * b.scrollratio.x : (d.pageY - b.rail.offset().top - b.cursorheight / 2) * b.scrollratio.y, c(e)) : (c = f ? b.doScrollLeftBy : b.doScrollBy, e = f ? b.scroll.x : b.scroll.y, d = f ? d.pageX - b.railh.offset().left : d.pageY - b.rail.offset().top, f = f ? b.view.w : b.view.h, e >= d ? c(f) : c(-f)))
            };
            ...
            this.init = function () {
                b.saved.css = [];
                if (g.isie7mobile) return !0;
                g.hasmstouch && b.css(b.ispage ? e("html") : b.win, {
                    "-ms-touch-action": "none"
                });
                b.zindex = "auto";
                b.zindex = !b.ispage && "auto" == b.opt.zindex ? h() : b.opt.zindex;
                !b.ispage && b.zindex && b.zindex > u && (u = b.zindex);
                if (!b.ispage || !g.cantouch && !g.isieold && !g.isie9mobile) {
                    ...
                    var l, k, m = ["left", "right"],
                        F;
                    for (F in m) k = m[F], (l = b.opt.railpadding[k]) ? f.css("padding-" + k, l + "px") : b.opt.railpadding[k] = 0;
                    f.append(c);
                    ...
                    if (b.opt.horizrailenabled) {
                        ...
                        n.height = Math.max(parseFloat(b.opt.cursorwidth), c.outerHeight());
                        n.css({
                            height: n.height + "px",
                            zIndex: b.zindex,
                            background: b.opt.background,
                        ...
                        n.visibility = !0;
                        n.scrollable = !0;
                        n.align = "top" == b.opt.railvalign ? 0 : 1;
                        b.railh = n;
                        b.railh.drag = !1
                    }
                    b.ispage ? (f.css({
                        ...
                        (n.css({
                            ...
                            top: "0px"
                        }), b.body.append(n))) : (b.ishwscroll ? ("static" == b.win.css("position") && b.css(b.win, {
                            position: "relative"
                        ...
                        n.css({
                            top: 0
                        }), d.append(n))) : (b.isfixed = "fixed" == b.win.css("position"), d = b.isfixed ? "fixed" : "absolute", b.isfixed || (b.viewport = b.getViewport(b.win[0])), b.viewport && (b.body = b.viewport, !1 == /relative|absolute/.test(b.viewport.css("position")) && b.css(b.viewport, {
                            position: "relative"
                        })), f.css({
                            position: d
                        }), b.zoom && b.zoom.css({
                            position: d
                        }), b.updateScrollBar(), b.body.append(f), b.zoom && b.body.append(b.zoom), b.railh && (n.css({
                            position: d
                        }), b.body.append(n))), g.isios && b.css(b.win, {
                    ...
                    !1 === b.opt.autohidemode ? (b.autohidedom = !1, b.rail.css({
                        ...
                        opacity: b.opt.cursoropacitymax
                    })) : !0 === b.opt.autohidemode ? (b.autohidedom = e().add(b.rail), b.railh && (b.autohidedom = b.autohidedom.add(b.railh))) : "scroll" == b.opt.autohidemode ? (b.autohidedom = e().add(b.rail), b.railh && (b.autohidedom = b.autohidedom.add(b.railh))) :
                        "cursor" == b.opt.autohidemode ? (b.autohidedom = e().add(b.cursor), b.railh && (b.autohidedom = b.autohidedom.add(b.railh.cursor))) : "hidden" == b.opt.autohidemode && (b.autohidedom = !1, b.hide(), b.locked = !1);
                    if (g.isie9mobile) b.scrollmom = new G(b), b.onmangotouch = function (d) {
                        d = b.getScrollTop();
                        var c = b.getScrollLeft();
                        if (d == b.scrollmom.lastscrolly && c == b.scrollmom.lastscrollx) return !0;
                        var f = d - b.mangotouch.sy,
                            e = c - b.mangotouch.sx;
                        if (0 != Math.round(Math.sqrt(Math.pow(e, 2) + Math.pow(f, 2)))) {
                            var p = 0 > f ? -1 : 1,
                                g = 0 > e ? -1 : 1,
                                h = +new Date;
                            b.mangotouch.lazy && clearTimeout(b.mangotouch.lazy);
                            80 < h - b.mangotouch.tm || b.mangotouch.dry != p || b.mangotouch.drx != g ? (b.scrollmom.stop(), b.scrollmom.reset(c, d), b.mangotouch.sy = d, b.mangotouch.ly = d, b.mangotouch.sx = c, b.mangotouch.lx = c, b.mangotouch.dry = p, b.mangotouch.drx = g, b.mangotouch.tm = h) : (b.scrollmom.stop(), b.scrollmom.update(b.mangotouch.sx - e, b.mangotouch.sy - f), b.mangotouch.tm = h, f = Math.max(Math.abs(b.mangotouch.ly - d), Math.abs(b.mangotouch.lx - c)), b.mangotouch.ly = d, b.mangotouch.lx = c, 2 < f && (b.mangotouch.lazy =
                                setTimeout(function () {
                                    b.mangotouch.lazy = !1;
                                    b.mangotouch.dry = 0;
                                    b.mangotouch.drx = 0;
                    ...
                    }, f = b.getScrollTop(), n = b.getScrollLeft(), b.mangotouch = {
                        sy: f,
                        ly: f,
                        dry: 0,
                        sx: n,
                        ...
                        if (g.cantouch || b.istouchcapable || b.opt.touchbehavior || g.hasmstouch) {
                                ...
                                if (!b.locked) {
                                    ...
                                    if (b.ispage || !b.opt.directionlockdeadzone) b.rail.drag.dl = "f";
                                        ...
                                        var f = e(window).width(),
                                            ...
                                            p = Math.max(0, l - p),
                                            f = Math.max(0, h - f);
                                        b.rail.drag.ck = !b.rail.scrollable && b.railh.scrollable ? 0 < p ? "v" : !1 : b.rail.scrollable && !b.railh.scrollable ?
                                            0 < f ? "h" : !1 : !1;
                            ...
                            var q = b.opt.touchbehavior && b.isiframe && !g.hasmousecapture;
                            b.ontouchmove = function (d, c) {
                                ...
                                if (b.rail.drag && 2 == b.rail.drag.pt) {
                                    ...
                                    b.synched("touchmove", function () {
                                        b.rail.drag && 2 == b.rail.drag.pt && (b.prepareTransition && b.prepareTransition(0), b.rail.scrollable && b.setScrollTop(r), b.scrollmom.update(l,
                                            h), b.railh && b.railh.scrollable ? (b.setScrollLeft(m), b.showCursor(r, m)) : b.showCursor(r), g.isie10 && document.selection.clear())
                                    });
                        ...
                        }, b.onmousedown = b.ontouchstart, b.onmouseup = b.ontouchend, b.onclick = g.isios ? !1 : function (d) {
                            return b.lastmouseup ? (b.lastmouseup = !1, b.cancelEvent(d)) :
                                !0
                        }, b.onmousemove = b.ontouchmove, b.opt.grabcursorenabled && g.cursorgrabvalue && (b.css(b.ispage ? b.doc : b.win, {
                            ...
                            b.onmousemove = function (d) {
                                if (b.rail.drag && 1 == b.rail.drag.pt) {
                                    ...
                                    b.synched("mousemove", function () {
                                        b.rail.drag && 1 == b.rail.drag.pt && (b.showCursor(), b.rail.drag.hr ? b.doScrollLeft(Math.round(b.scroll.x * b.scrollratio.x)) : b.doScrollTop(Math.round(b.scroll.y * b.scrollratio.y)))
                                    });
                                    return b.cancelEvent(d)
                                }
                            };
                        ...
                        !g.cantouch && !b.opt.touchbehavior && (b.jqbind(b.rail, "mouseenter", function () {
                            ...
                            b.opt.sensitiverail && (b.bind(b.rail, "click", function (d) {
                                ...
                                b.cancelEvent(d)
                            })), !b.ispage && b.opt.enablescrollonselection && (b.bind(b.win[0], "mousedown", b.onselectionstart), b.bind(document, "mouseup", b.onselectionend), b.bind(document, "mousemove", b.onselectiondrag)), b.railh && (b.jqbind(b.railh, "mouseenter", function () {
                        ...
                        b.opt.enablemousewheel && (b.isiframe || b.bind(g.isie && b.ispage ? document : b.docscroll, "mousewheel", b.onmousewheel), b.bind(b.rail, "mousewheel", b.onmousewheel), b.railh && b.bind(b.railh, "mousewheel", b.onmousewheelhr));
                        !b.ispage && (!g.cantouch && !/HTML|BODY/.test(b.win[0].nodeName)) && (b.win.attr("tabindex") || b.win.attr({
                            tabindex: I++
                        }), b.jqbind(b.win, "focus", function (d) {
                            x = b.getTarget(d).id || !0;
                            b.hasfocus = !0;
                    ...
                    b.onkeypress = function (d) {
                        ...
                        if (b.hasfocus || b.hasmousefocus &&
                            ...
                            switch (c) {
                                ...
                                case 37:
                                case 63232:
                                    b.railh && (f ? b.doScrollLeft(0) : b.doScrollLeftBy(72), e = !0);
                                    break;
                                case 39:
                                case 63234:
                                    b.railh && (f ? b.doScrollLeft(b.page.maxw) : b.doScrollLeftBy(-72), e = !0);
                                    break;
                                case 33:
                                case 63276:
                                ...
                                case 63275:
                                    ...
                                    break;
                                case 32:
                                    b.opt.spacebarenabled && (p ? b.doScrollBy(b.view.h) : b.doScrollBy(-b.view.h), e = !0);
                                    break;
                                case 27:
                                    b.zoomactive && (b.doZoom(), e = !0)
                            }
                            if (e) return b.cancelEvent(d)
                        }
                    };
                    b.opt.enablekeyboard && b.bind(document, g.isopera && !g.isopera12 ? "keypress" : "keydown", b.onkeypress);
                    b.bind(window, "resize", b.lazyResize);
                    b.bind(window, "orientationchange",
                        b.lazyResize);
                    ...
                    !b.ispage && !b.haswrapper && (!1 !== y ? (b.observer = new y(function (d) {
                        ...
                        attributes: !0,
                        subtree: !1
                    }), b.observerremover = new y(function (d) {
                ...
                if ("IFRAME" == this.doc[0].nodeName) {
                    var H = function (d) {
                        ...
                        b.isiframe && (b.iframe = {
                            ...
                            return {
                                w: Math.max(b.iframe.html.scrollWidth,
                        ...
                        "contentWindow" in this ? b.bind(this.contentWindow, "scroll", b.onscroll) : b.bind(c,
                            "scroll", b.onscroll);
                        b.opt.enablemousewheel && b.bind(c, "mousewheel", b.onmousewheel);
                        b.opt.enablekeyboard && b.bind(c, g.isopera ? "keypress" : "keydown", b.onkeypress);
                        if (g.cantouch || b.opt.touchbehavior) b.bind(c, "mousedown", b.onmousedown), b.bind(c, "mousemove", function (d) {
                            b.onmousemove(d, !0)
                        }), b.opt.grabcursorenabled && g.cursorgrabvalue && b.css(e(c.body), {
                            cursor: g.cursorgrabvalue
                        });
                        b.bind(c, "mouseup", b.onmouseup);
                        b.zoom && (b.opt.dblclickzoom && b.bind(c, "dblclick", b.doZoom), b.ongesturezoom && b.bind(c, "gestureend",
                            b.ongesturezoom))
                    };
            ...
            this.showCursor = function (d, c) {
                ...
                b.rail && (b.autohidedom && (b.autohidedom.stop().css({
                    opacity: b.opt.cursoropacitymax
                }), b.cursoractive = !0), "undefined" != typeof d && !1 !== d && (b.scroll.y = Math.round(1 * d / b.scrollratio.y)), "undefined" != typeof c && (b.scroll.x = Math.round(1 * c / b.scrollratio.x)), b.cursor.css({
            ...
            this.getContentSize = b.ispage ? function () {
                ...
                return {
                    ...
                    h: b.doc.outerHeight() + parseInt(b.win.css("paddingTop")) +
            ...
            this.onResize = function (d, c) {
                ...
                if (b.page.maxh == f && b.page.maxw == e && b.view.w == g) {
                    if (b.ispage) return b;
                    f = b.win.offset();
                    if (b.lastposition && (e = b.lastposition, e.top == f.top && e.left == f.left)) return b;
                    b.lastposition = f
                }
                0 == b.page.maxh ? (b.hideRail(), b.scrollvaluemax = 0, b.scroll.y = 0, b.scrollratio.y = 0, b.cursorheight = 0, b.setScrollTop(0), b.rail.scrollable = !1) : b.rail.scrollable = !0;
                0 == b.page.maxw ? (b.hideRailHr(), b.scrollvaluemaxw = 0, b.scroll.x =
                    0, b.scrollratio.x = 0, b.cursorwidth = 0, b.setScrollLeft(0), b.railh.scrollable = !1) : b.railh.scrollable = !0;
                ...
                b.cursorheight = b.opt.cursorfixedheight ? b.opt.cursorfixedheight :
            ...
            this._bind = function (d, c, f, e) {
                ...
                d.addEventListener ? d.addEventListener(c, f, e || !1) : d.attachEvent ? d.attachEvent("on" + c, f) : d["on" + c] = f
            };
            ...
            this.bind = function (d, c, f, e) {
                ...
                h.addEventListener ? (g.cantouch && /mouseup|mousedown|mousemove/.test(c) && b._bind(h, "mousedown" == c ? "touchstart" : "mouseup" == c ? "touchend" : "touchmove", function (b) {
                    if (b.touches) {
                    ...
                    } else b.changedTouches &&
                        (d = b.changedTouches[0], d.original = b, f.call(this, d))
                }, e || !1), b._bind(h, c, f, e || !1), "mousewheel" == c && b._bind(h, "DOMMouseScroll", f, e || !1), g.cantouch && "mouseup" == c && b._bind(h, "touchcancel", f, e || !1)) : b._bind(h, c, function (d) {
                    if ((d = d || window.event || !1) && d.srcElement) d.target = d.srcElement;
                    "pageY" in d || (d.pageX = d.clientX + b.getScrollLeft(), d.pageY = d.clientY + b.getScrollTop());
                    return !1 === f.call(h, d) || !1 === e ? b.cancelEvent(d) : !0
                })
            };
            this._unbind = function (b, c, f, e) {
                b.removeEventListener ? b.removeEventListener(c, f, e) :
                    b.detachEvent ? b.detachEvent("on" + c, f) : b["on" + c] = !1
            };
            ...
            this.getViewport = function (b) {
                for (b = b && b.parentNode ? b.parentNode : !1; b && 1 == b.nodeType && !/BODY|HTML/.test(b.nodeName) ;) {
                    var c = e(b),
                        f = c.css("overflowY") || c.css("overflowX") || c.css("overflow") || "";
            ...
            this.onmousewheelhr = function (d) {
                ...
                b.opt.preservenativescrolling && b.checkarea + 600 < c && (b.nativescrollingarea = b.isScrollable(d),
                    f = !0);
                b.checkarea = c;
                return b.nativescrollingarea ? !0 : b.locked ? b.cancelEvent(d) : m(d, !0, f)
            };
            this.stop = function () {
                b.cancelScroll();
            ...
            b.opt.smoothscroll ? b.ishwscroll && g.hastransition && b.opt.usetransition ? (this.prepareTransition = function (d,
                c) {
                ...
                b.timer = setTimeout(function () {
                    ...
                    l = b.prepareTransition(b.newscrollspeed ? b.newscrollspeed :
                        l);
                    ...
                    0 < l && (!b.scrollrunning && b.onscrollstart && b.onscrollstart.call(b, {
                        ...
                        bz: new BezierClass(f, b.newscrolly, l, 0, 0, 0.58,
                            1),
                ...
                function f() {
                    ...
                    b.scrollrunning = !0;
                    if (q = 1 - q) return b.timer = v(f) || 1;
                    var c = 0,
                        d = sy = b.getScrollTop();
                    if (b.dst.ay) {
                        var d = b.bzscroll ? b.dst.py + b.bzscroll.getNow() * b.dst.ay : b.newscrolly,
                            e = d - sy;
                        if (0 > e && d < b.newscrolly || 0 < e && d > b.newscrolly) d = b.newscrolly;
                        b.setScrollTop(d);
                        d == b.newscrolly && (c = 1)
                    } else c = 1;
                    ...
                    if (b.dst.ax) {
                        ...
                        e = g - sx;
                        if (0 > e && g < b.newscrollx || 0 < e && g > b.newscrollx) g = b.newscrollx;
                        b.setScrollLeft(g);
                        g == b.newscrollx && (c += 1)
                    } else c += 1;
                ...
                e = "undefined" == typeof e || !1 === e ? b.getScrollTop(!0) : e;
                if (b.timer && b.newscrolly == e && b.newscrollx == c) return !0;
                b.timer && w(b.timer);
                b.timer = 0;
                var g = b.getScrollTop(),
                    h = b.getScrollLeft();
                (0 > (b.newscrolly - g) * (e - g) || 0 > (b.newscrollx - h) * (c - h)) && b.cancelScroll();
                b.newscrolly = e;
                b.newscrollx = c;
                ...
                b.dst.px = h;
                b.dst.py = g;
                var l = Math.round(Math.sqrt(Math.pow(b.dst.x, 2) + Math.pow(b.dst.y, 2)));
                b.dst.ax = b.dst.x / l;
                b.dst.ay = b.dst.y / l;
                var k = 0,
                    m = l;
                0 == b.dst.x ? (k = g, m = e, b.dst.ay = 1, b.dst.py = 0) : 0 == b.dst.y && (k = h, m = c, b.dst.ax = 1, b.dst.px = 0);
                l = b.getTransitionSpeed(l);
                b.bzscroll = 0 < l ? b.bzscroll ? b.bzscroll.update(m, l) : new BezierClass(k, m, l, 0, 1, 0, 1) : !1;
                if (!b.timer) {
                ...
                0 > g && (g = 0);
                var h = e > b.page.maxh ? b.page.maxh : e;
                0 > h && (h = 0);
            ...
            this.doScrollBy = function (c, e) {
                var f = 0,
                    f = e ? Math.floor((b.scroll.y - c) * b.scrollratio.y) : (b.timer ? b.newscrolly : b.getScrollTop(!0)) - c;
                if (b.bouncescroll) {
            ...
            this.doScrollLeftBy = function (c, e) {
                var f = 0,
                    f = e ? Math.floor((b.scroll.x - c) * b.scrollratio.x) : (b.timer ? b.newscrollx : b.getScrollLeft(!0)) - c;
                if (b.bouncescroll) {
            ...
            this.doZoomIn = function (c) {
                if (!b.zoomactive) {
                    ...
                    for (l in h) {
                        var k = h[l];
                        b.zoomrestore.style[k] = "undefined" != typeof f[k] ? f[k] : ""
                    }
        ...
        G = function (e) {
            ...
            this.update = function (e, l) {
                ...
                var k = l - c.lasty,
                    b = e - c.lastx,
                    q = c.nc.getScrollTop(),
                    g = c.nc.getScrollLeft(),
                    q = q + k,
                    g = g + b;
                c.snapx = 0 > g || g > c.nc.page.maxw;
            ...
            this.doMomentum = function (e) {
                ...
                var b = c.nc.getScrollTop(),
                    q = c.nc.page.maxh,
                    g = c.nc.page.maxw;
                c.speedx = 0 < g ? Math.min(60, c.speedx) : 0;
                c.speedy = 0 < q ? Math.min(60, c.speedy) : 0;
                k = k && 50 >= l - k;
                if (0 > b || b > q || 0 > e || e > g) k = !1;
                e = c.speedx && k ? c.speedx : !1;
                if (c.speedy && k && c.speedy || e) {
                    var t = Math.max(16, c.steptime);
                    50 < t && (e = t / 50, c.speedx *= e, c.speedy *= e, t = 50);
                    c.demulxy = 0;
                    c.lastscrollx =
                        c.nc.getScrollLeft();
                    ...
                    var s = c.lastscrollx,
                        d = c.lastscrolly,
                        p = function () {
                            var b = 600 < c.time() - l ? 0.04 : 0.02;
                            if (c.speedx && (s = Math.floor(c.lastscrollx - c.speedx * (1 - c.demulxy)), c.lastscrollx = s, 0 > s || s > g)) b = 0.1;
                            if (c.speedy && (d = Math.floor(c.lastscrolly - c.speedy * (1 - c.demulxy)), c.lastscrolly = d, 0 > d || d > q)) b = 0.1;
                            c.demulxy = Math.min(1, c.demulxy + b);
                            c.nc.synched("domomentum2d", function () {
                                c.speedx && (c.nc.getScrollLeft() != c.chkx && c.stop(), c.chkx =
                                    s, c.nc.setScrollLeft(s));
                                c.speedy && (c.nc.getScrollTop() != c.chky && c.stop(), c.chky = d, c.nc.setScrollTop(d));
                                c.timer || (c.nc.hideCursor(), c.doSnapy(s, d))
                            });
                            1 > c.demulxy ? c.timer = setTimeout(p, t) : (c.stop(), c.nc.hideCursor(), c.doSnapy(s, d))
                        };
                    p()
    ...
    e.cssHooks.pageYOffset = {
        get: function (k, c, h) {
            return (c = e.data(k, "__nicescroll") || !1) && c.ishwscroll ? c.getScrollTop() : z.call(k)
        },
        set: function (k, c) {
            var h = e.data(k, "__nicescroll") || !1;
            h && h.ishwscroll ?
                h.setScrollTop(parseInt(c)) : z.call(k, c);
            return this
        }
    };
    e.fn.scrollTop = function (k) {
        if ("undefined" == typeof k) {
            ...
            return c && c.ishwscroll ? c.getScrollTop() : z.call(this)
        }
        return this.each(function () {
            var c = e.data(this, "__nicescroll") || !1;
            c && c.ishwscroll ? c.setScrollTop(parseInt(k)) : z.call(e(this), k)
        })
    };
    var A = e.fn.scrollLeft;
    e.cssHooks.pageXOffset = {
        get: function (k, c, h) {
            return (c = e.data(k, "__nicescroll") || !1) && c.ishwscroll ? c.getScrollLeft() : A.call(k)
        },
        set: function (k,
            c) {
            var h = e.data(k, "__nicescroll") || !1;
            h && h.ishwscroll ? h.setScrollLeft(parseInt(c)) : A.call(k, c);
            return this
        }
    };
    e.fn.scrollLeft = function (k) {
        if ("undefined" == typeof k) {
            var c = this[0] ? e.data(this[0], "__nicescroll") || !1 : !1;
            return c && c.ishwscroll ? c.getScrollLeft() : A.call(this)
        }
        return this.each(function () {
            var c = e.data(this, "__nicescroll") || !1;
            c && c.ishwscroll ? c.setScrollLeft(parseInt(k)) : A.call(e(this), k)
        })
    };
    var B = function (k) {
        var c = this;
    ...
    })(B.prototype, "show hide toggle onResize resize remove stop doScrollPos".split(" "), function (e, c) {
        e[c] = function () {
            var e = arguments;
            return this.each(function () {
                this[c].apply(this, e)
    ...
    e.fn.getNiceScroll = function (k) {
        return "undefined" ==
            typeof k ? new B(this) : e.data(this[k], "__nicescroll") || !1
    };
    e.extend(e.expr[":"], {
    ...
    e.fn.niceScroll = function (k, c) {
        ...
        this.each(function () {
            ...
            k || (c.doc = l ? e(this) : c.doc, k = new N(c, e(this)), e(this).data("__nicescroll",
                k));
            h.push(k)
        });
    ...
    e.nicescroll || (e.nicescroll = new B, e.nicescroll.options = E)
})(jQuery);