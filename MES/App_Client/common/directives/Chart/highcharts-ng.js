...
angular.module('highcharts-ng', [])
  .factory('highchartsNGUtils', function () {
      ...
      var getMergedOptions = function (scope, element, config) {
          ...
          if (config.chart.spacingTop) {
              mergedOptions.chart.spacingTop = config.chart.spacingTop;
          }
          if (config.chart.spacingBottom) {
              mergedOptions.chart.spacingBottom = config.chart.spacingBottom;
          }
          if (config.chart.spacingLeft) {
              mergedOptions.chart.spacingLeft = config.chart.spacingLeft;
          }
          if (config.chart.spacingRight) {
              mergedOptions.chart.spacingRight = config.chart.spacingRight;
          }
          ...
          if (config.mapNavigation) {
              mergedOptions.mapNavigation = config.mapNavigation;
          }
          if (config.colorAxis) {
              mergedOptions.colorAxis = config.colorAxis;
          }
      ...
      return {
          ...
          link: function (scope, element, attrs) {
              ...
              scope.$watch('config.useHighMaps', function (useHighMaps, oldUseHighMaps) {
                  if (useHighMaps === oldUseHighMaps) return;
                  initChart();
              });
