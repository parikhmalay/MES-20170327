            ...
            self.addOrUpdateNotifyConfig('default',
                {
                    ...
                    template:
                        '<div class="alert aa-notify-notification" ng-class="notification.cssClasses">' +
                            '<div class="aa-notify-close" ng-if="notification.showClose" ng-click="close(notification)">' +
                                    '<i class="aa-notify-icon" ng-if="notification.iconClass" ng-class="notification.iconClass"></i>' +
                            '</div>' +
                            '<p ng-if="!notification.allowHtml" class="aa-notify-message">{{notification.message}}</p>' +
                            '<p ng-if="notification.allowHtml" class="aa-notify-message" ng-bind-html="notification.message"></p>' +
                        '</div>',
                    options: {
