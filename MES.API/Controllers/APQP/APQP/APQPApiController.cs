...
namespace MES.API.Controllers.APQP.APQP
{
    ...
    public class APQPApiController : SecuredApiControllerBase
    {
        ...
        [HttpPostRoute("ExportAPQPNewBusinessAwardedReport")]
        public NPE.Core.ITypedResponse<bool?> ExportAPQPProjectStatusReport(GenericPage<MES.DTO.Library.APQP.APQP.APQPNewBusinessAwardedReportSearchCriteria> searchCriteria)
        {
            var type = this.Resolve<IAPQPRepository>(APQPRepository).ExportAPQPNewBusinessAwardedReport(searchCriteria);
            return type;
        }
        #endregion
