...
{
    [AdminPrefix("CustomerContactsApi")]
    public class CustomerContactsApiController : SecuredApiControllerBase
    {
        [Inject]
        ...
        /// <returns></returns>
        [HttpGetRoute("Get")]
        public ITypedResponse<MES.DTO.Library.RFQ.Customer.Contacts> Get(int Id)
        {
        ...
        /// <returns></returns>
        [HttpPostRoute("Save")]
        public ITypedResponse<int?> Save(MES.DTO.Library.RFQ.Customer.Contacts contacts)
        {
        ...
        public List<MES.DTO.Library.RFQ.Customer.Contacts> GetContactsList(int customerId)
        {
            var type = this.Resolve<IContactsRepository>(ContactsRepository).GetContactsList(customerId);
            return type;
        }
        #endregion Methods
    }
